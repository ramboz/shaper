...
>
> Current state of all specs for shaper. Update after each slice transition.
>
...
| [003-hybrid-plugin-baseline](003-hybrid-plugin-baseline/spec.md) | 003-01 - hybrid-plugin-baseline | RECONCILED |  |
