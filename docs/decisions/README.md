...
- [ADR-0005: Vertical-scope shaping and a bounded architecture-appetite handoff](adr-0005-vertical-scope-shaping-and-architecture-appetite.md) — shaper's charter is to shape raw product intent into a bounded release plan "before and above JIG specs," then hand implementation-ready work to jig ([product-vision.md](../product-vision.md) Identity / Positioning). (2026-08-11, Proposed)
