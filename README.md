...
accepted the major architecture decisions, but product skills are not yet
implemented.

| Surface | Role | Status |
|---|---|---|
| Hybrid plugin baseline | Codex and Claude Code host package layout | ADR-0001 accepted, Spec 003 draft |
...
Those install surfaces will become real after the hybrid plugin baseline and
release automation specs land. Until then, treat this repository as the source
of truth, not an installable runtime.
...
The planned product layout after the hybrid plugin baseline lands:
